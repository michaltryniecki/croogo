...
abstract class BaseStorageHandler
{
    ...
    public function __construct($config = [])
    {
        ...
        try {
            $this->Attachments = \Cake\ORM\TableRegistry::getTableLocator()->get('Croogo/FileManager.Attachments');
        } catch (Exception $e) {
    ...
    protected function _createAsset($attachment)
    {
        ...
        $Assets = \Cake\ORM\TableRegistry::getTableLocator()->get('Croogo/FileManager.Assets');
