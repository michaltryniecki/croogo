...
class PluginManagerCacheTest extends TestCase
{
    ...
    /**
     * unload() only detaches listeners, it does not drop the plugin instance
     *
     * @return void
     */
    protected function _unloadTestPlugin()
    {
        if (!Plugin::isLoaded(static::PLUGIN)) {
            return;
        }
        PluginManager::unload(static::PLUGIN);
     ...
     */
    protected function _pluginManager()
    {
     ...
     * @return void
     */
    public function testLoadKeepsEventHandlersCache()
    {
     ...
     * @return void
     */
    public function testActivateInvalidatesEventHandlersCacheOnce()
    {
    ...
    /**
     * deactivate() delegates to unload(), the single invalidation point
     *
     * @return void
     */
    public function testDeactivateInvalidatesEventHandlersCacheOnce()
    {
     ...
     * @return void
     */
    public function testInvalidationLeavesOtherCachedSettingsKeysAlone()
    {
        $manager = $this->_pluginManager();
     ...
     * @return void
     */
    public function testUnloadWithoutCachedSettingsConfigDoesNotThrow()
    {
        Cache::drop('cached_settings');
