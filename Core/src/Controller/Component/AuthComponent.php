...
use Croogo\Core\Auth\BaseAuthorize;
use Croogo\Core\Auth\Storage\StorageInterface;
...
class AuthComponent extends Component implements EventDispatcherInterface
{
     ...
     *
     * @var array<\Croogo\Core\Auth\BaseAuthenticate>
     */
     ...
     *
     * @var array<\Croogo\Core\Auth\BaseAuthorize>
     */
     ...
     * Storage object.
     *
     * @var \Croogo\Core\Auth\Storage\StorageInterface|null
     */
    protected $_storage;
     ...
     * in the same request
     *
     * @var \Croogo\Core\Auth\BaseAuthenticate|null
     */
     ...
     *
     * @var \Croogo\Core\Auth\BaseAuthorize|null
     */
     ...
     * @return \Croogo\Core\Auth\BaseAuthorize|null
     */
     ...
     *
     * @param \Croogo\Core\Auth\Storage\StorageInterface|null $storage Sets provided
     *   object as storage or if null returns configured storage object.
     * @return \Croogo\Core\Auth\Storage\StorageInterface|null
     */
    public function storage(?StorageInterface $storage = null): ?StorageInterface
    {
        ...
        /** @var \Croogo\Core\Auth\Storage\StorageInterface $storage */
     ...
     * @return \Croogo\Core\Auth\BaseAuthenticate|null
     */
