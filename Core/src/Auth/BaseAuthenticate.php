...
abstract class BaseAuthenticate implements EventListenerInterface
{
     ...
     *
     * @var \Croogo\Core\Auth\AbstractPasswordHasher|null
     */
     ...
     */
    protected function _query(string $username): \Cake\ORM\Query\SelectQuery
    {
        $config = $this->_config;
     ...
     *
     * @return \Croogo\Core\Auth\AbstractPasswordHasher Password hasher instance
